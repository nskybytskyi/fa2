...
\DeclareMathOperator{\linear}{lin}
\DeclareMathOperator{\cllinear}{\closure{lin}}
\DeclareMathOperator{\convex}{conv}
\DeclareMathOperator{\aconvex}{aconv}
\DeclareMathOperator{\claconvex}{\closure{aconv}}
