...
математики, а \vocab{функціональний аналіз} --- це розділ
...
називати носієм. \vocab{Топологією} в $X$ називається довільна
система $\tau$ його підмножин, яка задовольняє таким умовам
(\vocab{аксіомам Александрова}):
\begin{enumerate}
...
простором з \vocab{дискретною (максимальною) топологією}.
\end{example}

\begin{example}[топологічного простору]
Нехай $X$ --- довільна множина, $\tau = \{\emptyset, X\}$.
Пара $(X, \tau)$ називається простором з \vocab{тривіальною
...
Говорять, що топологія $\tau_1$ є \vocab{сильнішою}, або \vocab{тонкішою},
ніж топологія $\tau_2$, якщо $\tau_2 \subset \tau_1$. Відповідно, топологія $\tau_2$ є
\vocab{слабкішою}, або \vocab{грубішою}, ніж топологія $\tau_1$. Легко бачити,
...
називаються \vocab{відкритими}. Множини, які є доповненням до
відкритих множин, називаються \vocab{замкненими}.
\end{definition}
...
називається \vocab{індукованою}.
\end{definition}

\begin{definition}
Топологічний простір $(X, \tau)$ називається
\vocab{зв’язним}, якщо лише множини $X$ і $\emptyset$ є замкненими й
відкритими одночасно.
\end{definition}

\begin{definition}
Множина $M$ топологічного простору $(X, \tau)$
називається \vocab{зв’яз\-ною}, якщо топологічний простір $(M, \tau_M)$
є зв’язним.
\end{definition}
...
містить точку $x \in T$, називається її \vocab{околом}.
\end{definition}

\begin{definition}
Точка $x \in T$ називається \vocab{точкою дотику}
множини $M \subset T$, якщо кожний окіл $O(x)$ точки $x$ містить
хоча б одну точку із $M$: $\forall O(x) \in \tau: O(x) \cap M \ne \emptyset$.
\end{definition}

\begin{definition}
Точка $x \in T$ називається \vocab{граничною точкою}
...
називається \vocab{замиканням} множини $M$ і позначається $\closure M$.
\end{definition}

\begin{definition}
Сукупність граничних точок множини
$M \subset T$ називається \vocab{похідною} множини $M$ і позначається
$M'$.
\end{definition}

\begin{theorem}
[про властивості замикання] Замикання
...
\begin{theorem}
[критерій замкненості] Множина $M$
...
просторі $T$. Множина $A$ називається \vocab{щільною в $B$}, якщо
$\closure A \supset B$.
\end{definition}
...
\begin{definition}
Множина $A$ називається \vocab{ніде не щільною},
...
множину, називається \vocab{сепарабельним}.
\end{definition}
...
З того, що $\closure \QQ = \RR$ і $\closure{\RR \setminus \QQ} = \RR$,
