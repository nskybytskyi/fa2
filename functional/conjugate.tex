...
\vocab{лінійним топологічним простором}, якщо
\begin{enumerate}
...
топологічному просторі $L$, називається \vocab{неперервним}, якщо
...
\begin{definition}
\vocab{Сильною топологією} в просторі $\conjugate E$
...
\begin{definition}
\vocab{Другим спряженим простором} $\dconjugate E$
...
лемі 11.2, називається \vocab{природнім відображенням} простору
