...
називається \vocab{ортогональною}, якщо
$(e_k, e_l) = 0$ при $k \ne l$.
\end{definition}
...
\vocab{лінійною оболонкою} множини $A$, або лінійним
...
\begin{definition}
Система $\{e_k\} \subset E$ називається \vocab{повною},
...
називається \vocab{ортонормованим базисом}.
\end{definition}
...
називається \vocab{замкненою}, якщо для довільного $f \in E$
виконується \vocab{рівність Парсеваля}
\begin{equation}
...
Числа $c_k$ називаються \vocab{координатами}, або \vocab{коефіцієнтами
Фур’є} елемента $f$ по системі $\{\phi_k\} \subset E$, а ряд
\begin{equation*}
...
\begin{theorem}
[Рісса---Фішера] Нехай $\{\phi_k\} \subset E$ --- довільна
...
\begin{theorem}
[про ізоморфізм] Довільні два сепарабельних
